...
test_videos_path = path.VALIDATION_VIDEOS_PATH
#path of the val video annotations
test_annotations_path = 'TH14_Temporal_annotations_validation/annotation'
...
with open('validation_ground_truth.json', 'w') as f:
