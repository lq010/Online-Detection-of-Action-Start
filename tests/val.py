...
def main(id):
    ...
    weights_dir = './weight'
    model_weight_filename = '/home/lq/Documents/Thesis/Thesis/results/adam_temporal_r3/weights/predictions_weights.02-2.767.hdf5'
    N_classes = 20+1
    batch_size = 32
    epochs = 4
    ...
    N_val_iterations = N_val_samples//batch_size - 1
# ####################################
    ...
    print ("# val it : {}".format(N_val_iterations))            
...
# ##################################
    ...
    result_dir = './results/adam_temporal_val_{}/'.format(id)
    ...
    history = model.evaluate_generator(val_generator, steps=N_val_iterations,verbose=1)                                         
