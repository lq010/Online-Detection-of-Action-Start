...
Explore
 @lq010 Sign out
153
1,589 480 openai/improved-gan
 Code  Issues 29  Pull requests 4  Projects 0  Wiki  Insights
improved-gan/mnist_svhn_cifar10/train_mnist_feature_matching.py
0fa06b5  on 14 Jun 2016
@TimSalimans TimSalimans param averaging everywhere
     
162 lines (141 sloc)  6.95 KB
import sys
import argparse
import numpy as np
import theano as th
