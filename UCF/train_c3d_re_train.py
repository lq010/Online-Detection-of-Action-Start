...
from ucf_src.batch_generator_without_followup import val_batch_generator_15_percentage as val_batch_generator
...
#####################
    ...
    N_val_samples = len(val_A_windows)*2 +len(val_AS_windows)# len(val_AS_windows) + int(0.15*len(val_A_windows))+ int(0.15*len(val_BG_windows))
