...
from ucf_src.batch_generator import train_batch_generator_AS_A_BG_2_1_1 as train_batch_generator
from ucf_src.batch_generator import val_batch_generator
...
# ##################################
    ...
    result_dir = '/media/lq/C13E-1ED0/dataset/UCF_Crimes/results/adam_temporal_{}/'.format(id)
    ...
    with open(desp,'w') as f:
        f.write('batch size: {}\nbase_lr: {} \ntrain_samples:{} \n '.format(batch_size,base_lr,N_train_samples))
        f.write('loss_weight:{}\n'.format(loss_weights))
