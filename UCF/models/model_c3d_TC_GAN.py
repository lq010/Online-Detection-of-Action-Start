...
from dataUtil import load_train_data
from ucf_src.batch_generator_without_followup import batch_generator_AS_A_BG_2_1_1, batch_generator_AS
...
class GAN(object):
    ...
    def __init__(self, latent_dim=100, length=16, width=120, height=160, channels=3, c3d_weights=None):
    ...
    def train(self, iterations=5000, batch_size=16, save_it=[2500], id=0):
        ...
        #logs
        result_dir = '/media/lq/C13E-1ED0/dataset/UCF_Crimes/results/gan_{}/'.format(id)
