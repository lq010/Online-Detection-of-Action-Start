...
c3d_model = c3d_model.get_model(nb_classes=3)

weights_path = '/media/lq/C13E-1ED0/dataset/UCF_Crimes/results/gan_200/weights/c3d_TC_GAN_22_outputs_it200.hdf5'
save_path = weights_path.replace('_22_outputs_', '_1_outputs_')
n_classes =2
