...
from UCF.models import c3d_extractor
...
def predict_videos(videos_dir, output_file, weights_file, 
    ...
    class predict_task(threading.Thread):
        ...
        def run(self):
            ...
            # Loading the model
            print('Loading model')
            model = c3d_extractor.get_model(weights_file)
...
if __name__ == '__main__':
    ...
    prediction_file_name = 'ucf_features_' + args.weight_name

    predict_videos(videos_dir = args.video_dir, 
                    output_file = args.output_file+"/features.h5", 
